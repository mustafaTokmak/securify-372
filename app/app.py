...
def get_search_result():
    ...
    if request.method == 'POST':
        ...
        recipe = {"direction":"asdasd","id":3095,"date":"20191125","fat":111,"calories":123,"description":"Test","protein":123,"rating":11,"title":"Ma","ingredientList":["ing1","ing2"],"ingredientDescription":"description","sodium":6,"categoryList":["cat2","cat1"]}
        recipes = []
